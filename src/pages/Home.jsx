...
const Home = () => {
  ...
  return (
    <div className="bg-transparent text-[var(--text-primary)] selection:bg-[var(--accent-gold)]/40 scroll-smooth transition-colors duration-700">
      ...
      {/* ── 01. HERO ── */}
      <section className="relative min-h-screen flex items-center overflow-hidden z-20 border-b border-[var(--border-color)] bg-black">
        <div className="absolute inset-0 z-0">
          ...
          >
            <img 
              src="/media/official_founder.png" 
              alt="Ghassan Farajallah" 
              className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 ${isArabic ? 'scale-x-[-1]' : ''}`}
            />
          </motion.div>
      ...
      {/* ── 02.5 SOCIAL PROOF: Social Media Channels ── */}
         ...
         >
            ...
            <div className="mb-20">
               <h2 className="text-7xl md:text-[11rem] font-black uppercase tracking-tighter leading-none italic">
                 ...
                 <span className="gold-gradient-text not-italic block">{lang === 'en' ? 'SOLUTIONS.' : 'سـولـوشـنـز.'}</span>
               </h2>
